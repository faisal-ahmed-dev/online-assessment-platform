...
export function EmployerSignIn() {
  const { signIn } = useAuth(UserRole.Employer)
        ...
        <div className="w-full max-w-[571px]">
          ...
          <div className="bg-white rounded-2xl border border-[#E5E7EB] p-8 shadow-sm">
            ...
            <p className="text-center text-xs text-[#9CA3AF] mt-4">
              Demo: <span className="font-mono">{MOCK_EMPLOYER_CREDENTIALS.email}</span> /{" "}
              <span className="font-mono">{MOCK_EMPLOYER_CREDENTIALS.password}</span>
            </p>
          </div>
        </div>
      </main>
